 ...
 */
export async function handleWsConnection(ws, { apiKey, rootDir, provider = "openai", modelId = "gpt-5.4" }) {
  try {
      ...
      switch (event.type) {
        ...
        case 'message_update':
          if (event.assistantMessageEvent?.type === 'text_delta') {
            ...
            ws.send(JSON.stringify({ type: 'thinking_delta', delta: event.assistantMessageEvent.delta }));
          }
          break;
